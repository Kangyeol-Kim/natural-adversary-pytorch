...
class WganD(nn.Module):
    ...
    def __init__(self, ngf=64):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(1, self.ngf, kernel_size=3, strid=2, padding=1),
            nn.LeakyReLU(), # 14 x 14

            nn.Conv2d(self.ngf, self.ngf * 2, kernel_size=3, strid=2, padding=1),
            nn.LeakyReLU(), # 7 x 7 
            
            nn.Conv2d(self.ngf * 2, self.ngf * 4, kernel_size=3, strid=2, padding=1),
            nn.LeakyReLU() # 4 x 4
        )
